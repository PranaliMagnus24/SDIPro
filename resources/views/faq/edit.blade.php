...
@section('content')
    <div class="container mt-3">
        <h1 class="text-right mb-1">Edit Faq</h1>
            ...
            <div class="card-body">
                <form action="{{ route('faq.update', $faq->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ $faq->title }}">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="description" id="description" class="form-control" value="{{ $faq->description }}">
                    </div>
                    <div class="mb-3">
